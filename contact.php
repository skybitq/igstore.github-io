...
$subject ="Новая заявка с сайта igstore.ml";
...
$header .= "From: Новая заявка <googglob@gmail.com>\n\n";	
$mail = mail("googglob@gmail.com", $subject1, iconv ('utf-8', 'windows-1251', $message1), iconv ('utf-8', 'windows-1251', $header));
